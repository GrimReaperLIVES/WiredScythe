...
const PUSHER_URL =
  ...
  "?protocol=7&client=wiredscythe&version=1.0";
...
// ones WiredScythe has artwork for are drawn as that glyph; the rest fall back
...
// art under its type name, which means a badge type WiredScythe has never seen
