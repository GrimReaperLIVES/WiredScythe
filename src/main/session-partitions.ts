 ...
 */
export const APP_UI_PARTITION = "persist:wiredscythe-app-ui";
/**
 ...
 */
export const MEDIA_UPSTREAM_PARTITION = "wiredscythe-media-upstream";
export const TWITCH_WEBSITE_PARTITION = "persist:wiredscythe-twitch-playback";
