...
const TOOLTIP_ATTRIBUTE = "data-wiredscythe-tooltip";
...
const TOOLTIP_IMAGE_ATTRIBUTE = "data-wiredscythe-tooltip-image";
const TOOLTIP_IMAGE_HEIGHT_ATTRIBUTE = "data-wiredscythe-tooltip-image-height";
const TOOLTIP_LARGE_ATTRIBUTE = "data-wiredscythe-tooltip-large";
const LINK_PREVIEW_ATTRIBUTE = "data-wiredscythe-link-preview";
...
export function ReactTooltipLayer({
  ...
  return tooltip
    ? createPortal(
        <div
          className={
            tooltip.linkPreview || tooltip.large
              ? "wiredscythe-react-tooltip has-preview"
              : "wiredscythe-react-tooltip"
          }
          role="tooltip"
        ...
        >
          {tooltip.linkPreview ? (
            <div className="wiredscythe-link-preview-card">
              {tooltip.linkPreview.thumbnailUrl && (
                <img
                  alt=""
                  className={
                    tooltip.linkPreview.thumbnailPresentation === "avatar"
                      ? "wiredscythe-tooltip-image is-avatar"
                      : "wiredscythe-tooltip-image"
                  }
                  onError={(event) => {
            ...
            <img
              alt=""
              className="wiredscythe-tooltip-image"
              decoding="async"
          ...
          {tooltip.text.includes("\n") ? (
            <span className="wiredscythe-tooltip-lines">
              {tooltip.text.split("\n").map((line, index) =>
