...
export const appPreferencesSchema = z.object({
  ...
  /**
   * Logins whose messages chat does not show. WiredScythe's own list — see
...
// Saved files can contain keys from an older WiredScythe version. Strip those
...
export const defaultAppPreferences: AppPreferences = {
  ...
  // Kick's public directory works in guest mode. Twitch's directory API needs
  // an authorized session, so starting guests here avoids a dead-end screen.
  browsePlatform: "kick",
