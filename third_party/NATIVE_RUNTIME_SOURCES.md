...
WiredScythe redistributes an unmodified Streamlink portable Windows runtime for
...
and dependency license metadata. WiredScythe omits the portable archive's
...
in the WiredScythe repository so an equivalent source archive can be restored
